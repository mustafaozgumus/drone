  ...
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 relative z-20 text-center">
        <div className="inline-flex items-center space-x-2 py-2 px-4 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-brand-400 text-xs font-bold tracking-[0.2em] uppercase mb-8 animate-fade-in hover:bg-white/10 transition-colors cursor-default">
          <span className="w-2 h-2 rounded-full bg-brand-500 animate-pulse"></span>
          <span>Nevşehir & Kapadokya</span>
        </div>
        
        <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-black text-white leading-none mb-8 animate-slide-up tracking-tighter">
          GÖKYÜZÜNDEN<br />
        ...
        <p className="text-gray-300 text-lg md:text-2xl max-w-3xl mx-auto mb-12 animate-slide-up font-light tracking-wide" style={{ animationDelay: '0.2s' }}>
          Sinematik drone çekimleriyle markanızın ve anılarınızın sınırlarını zorlayın. 
          <span className="text-white font-medium"> 4K/60FPS</span> kalitesinde profesyonel prodüksiyon.
        </p>
        
        <div className="flex flex-col sm:flex-row justify-center gap-6 animate-slide-up" style={{ animationDelay: '0.4s' }}>
          <a
            href="#contact"
            className="group relative px-8 py-4 bg-brand-600 text-white font-bold rounded-lg overflow-hidden shadow-[0_0_30px_rgba(217,119,6,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_50px_rgba(245,158,11,0.6)]"
          >
          ...
          <a
            href="#gallery"
            className="group px-8 py-4 bg-white/5 border border-white/10 text-white font-semibold rounded-lg backdrop-blur-sm hover:bg-white/10 transition-all hover:border-white/30 flex items-center justify-center space-x-3"
          >
            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-brand-500 group-hover:text-white transition-colors">
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-float">
        <a href="#services" className="flex flex-col items-center text-gray-500 hover:text-white transition-colors">
          <span className="text-[10px] uppercase tracking-[0.3em] mb-2">Keşfet</span>
